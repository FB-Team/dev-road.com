...
let NavTiles = props.component.children.map(child => <div className={s.NavTile} id={child.meta.id} onClick={onClickTile}><NavTile to={child.meta.path} onClick={onClickTile}proftitle={child.data.proftitle} profdesc={child.data.profdesc}/></div>
)
  return (
