...
FullStack.data.expanded = {
	desc: `<p>Fullstack это область, которая сочетает в себе front-end и back-end разработку. Фуллстек специалист может в одиночку создать сайт или веб приложение, что является несомненным преимуществом для небольших компаний либо работодателя на freelance. Такой специалист отлично понимает общую архитектуру сайта, и как клиентская и серверная часть взаимодействует друг с другом. Поэтому высокий порог вхождения и худшая компетенция для отдельных областей в сравнении с узкопрофильными специалистами вполне справедливая плата за все преимущества.</p>`,
